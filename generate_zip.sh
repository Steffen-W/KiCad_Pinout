...
mkdir -p plugins
git ls-files -- 'KiCad_Pinout/*.png' 'KiCad_Pinout/*.py' 'KiCad_Pinout/plugin.json' 'KiCad_Pinout/requirements.txt' '__init__.py' 'KiCad_Pinout/kicad_advanced' | xargs -I {} cp {} plugins/
...
echo "ZIP file created: $(realpath KiCad_Pinout.zip)"