...
mkdir -p plugins
git ls-files -- 'KiCad_Pinout/*.png' 'KiCad_Pinout/*.py' 'KiCad_Pinout/plugin.json' 'KiCad_Pinout/requirements.txt' '__init__.py' 'plugins/kicad_advanced' | cpio -pdm plugins
